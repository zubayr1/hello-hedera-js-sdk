...
async function main() {
	...
	//const fileCreateTx = new FileCreateTransaction().setKeys([treasuryKey]).setContents(bytecode).freezeWith(client);
    // filesize large. So create empty file first, then append bytecode.
